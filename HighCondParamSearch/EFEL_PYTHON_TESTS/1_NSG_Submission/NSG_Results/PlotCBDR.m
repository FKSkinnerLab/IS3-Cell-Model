...
font_weight = 'normal';
font_angle = 'normal';
Directory = [Case '/Cipres_Data/output/' Case '/NPYfiles/'];

%% Load Parameter Vectors
NumExc = readNPY([Directory Case '_NumExc.npy']);
NumInh = readNPY([Directory Case '_NumInh.npy']);
ExcSpikes = readNPY([Directory Case '_ExcSRSpikes.npy']);
InhSpikes = readNPY([Directory Case '_InhSpikes.npy']);
NumExcCommon = readNPY([Directory Case '_NumExcCommon.npy']);
NumInhCommon = readNPY([Directory Case '_NumInhCommon.npy']);

%% Load Measurement Vectors
ISICV = readNPY([Directory Case '_ISICV.npy']);
MeanAPamp = readNPY([Directory Case '_MeanAPamp.npy']);
MeanVolt = readNPY([Directory Case '_MeanVolt.npy']);
NumSpikes = readNPY([Directory Case '_NumSpikes.npy']);
StdVolt = readNPY([Directory Case '_StdVolt.npy']);
...
%% CBDR Variables
db_sim = sortrows(sortrows(sortrows(sortrows(sortrows(sortrows(db_sim,1),2),3),4),5),6);
...
saveas(gcf,[Case '_VMEANCBDR.pdf'])
...
saveas(gcf,[Case '_ISICVCBDR.pdf'])
...
saveas(gcf,[Case '_NSpikesCBDR.pdf'])
...
saveas(gcf,[Case '_HCMetricCBDR.pdf'])