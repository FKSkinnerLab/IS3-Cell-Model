...
NumInh = numpy.arange(34,346+1,34) # total-1 Because of synapse indexing starting at 0 in hoc code
NumExc = numpy.arange(153,1530+1,153) # total-1 Because of synapse indexing starting at 0 in hoc code
InhSpikes = numpy.arange(0,1000+1,250)
ExcSRSpikes = numpy.arange(0,300+1,100)
ExcSLMSpikes = numpy.arange(0,300+1,100)
NumExcCommon = numpy.array([1])
NumInhCommon = numpy.array([1])
