...
#define nrn_init _nrn_init__Ksoma
#define _nrn_initial _nrn_initial__Ksoma
#define nrn_cur _nrn_cur__Ksoma
#define _nrn_current _nrn_current__Ksoma
#define nrn_jacob _nrn_jacob__Ksoma
#define nrn_state _nrn_state__Ksoma
#define _net_receive _net_receive__Ksoma 
#define _f_rate _f_rate__Ksoma 
#define rate rate__Ksoma 
#define state state__Ksoma 
...
extern Memb_func* memb_func;
 ...
 "setdata_Ksoma", _hoc_setdata,
 "rate_Ksoma", _hoc_rate,
 "vtrap_Ksoma", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_Ksoma
...
#define _gth 0
#define ntau_Ksoma _thread1data[0]
#define ntau _thread[_gth]._pval[0]
#define nexp_Ksoma _thread1data[1]
#define nexp _thread[_gth]._pval[1]
#define ninf_Ksoma _thread1data[2]
#define ninf _thread[_gth]._pval[2]
#define usetable usetable_Ksoma
 double usetable = 1;
 ...
 "ninf_Ksoma", &ninf_Ksoma,
 "nexp_Ksoma", &nexp_Ksoma,
 "ntau_Ksoma", &ntau_Ksoma,
 "usetable_Ksoma", &usetable_Ksoma,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Ksoma /Users/alexgm/Desktop/SkinnerLab/Usages/RhythmTests_N1/Theta/IncreasedInputTests_LowSynsOnly/AllDelays_DoubleInputs/ThetaX1/SDprox1/x86_64/Ksoma.mod\n");
...
static int  _f_rate ( _threadargsprotocomma_ double _lv ) {
 ...
 _lq10 = pow( 3.0 , ( ( celsius - 24.0 ) / 10.0 ) ) ;
   _ltinc = - dt * _lq10 ;
   _lalpha = 0.018 * vtrap ( _threadargscomma_ - ( _lv - 25.0 ) , 25.0 ) ;
   _lbeta = 0.0036 * vtrap ( _threadargscomma_ _lv - 35.0 , 12.0 ) ;
...
static void _initlists(){
 ...
 _slist1[0] = &(n) - _p;  _dlist1[0] = &(Dn) - _p;
   ...
   _t_nexp = makevector(301*sizeof(double));
   _t_ntau = makevector(301*sizeof(double));
_first = 0;
}
