...
#define eNa eNa_nap
 double eNa = 55;
#define mtau_nap _thread1data[0]
#define mtau _thread[_gth]._pval[0]
#define minf_nap _thread1data[1]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 nap /Users/alexgm/Desktop/SkinnerLab/Usages/RhythmTests_N1/Theta/IncreasedInputTests_LowSynsOnly/AllDelays_RemoveInputs/ThetaX1/SDprox2/x86_64/Nap.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {int _reset = 0; {
   mtau = 5.0 ;
   minf = ( 1.0 / ( 1.0 + exp ( - ( v + 51.0 - sh ) / 5.0 ) ) ) ;
   Dm = ( minf - m ) / mtau ;
   }
 return _reset;
}
