...
for x2 in range(0,1):
	...
	for n in prethetanoise:
		for y in range(0,10):
			...
			if y == 3:
				...
				for item in leg.legendHandles:
					item.set_visible(False)
			if y == 4:
				axarr[4].plot(timevec,voltvec,'m',label='-SR90')
				...
				for item in leg.legendHandles:
					item.set_visible(False)
			if y == 5:
				axarr[5].plot(timevec,voltvec,'y',label='-SR180')
				...
				for item in leg.legendHandles:
					item.set_visible(False)
			if y == 6:
				axarr[6].plot(timevec,voltvec,'b',label='-SR270')
				...
				for item in leg.legendHandles:
					item.set_visible(False)
			if y == 7:
				axarr[7].plot(timevec,voltvec,'k',label='-SLM90')
				...
				for item in leg.legendHandles:
					item.set_visible(False)
			if y == 8:
				axarr[8].plot(timevec,voltvec,'orange',label='-SLM180')
				...
				for item in leg.legendHandles:
					item.set_visible(False)
			if y == 9:
				axarr[9].plot(timevec,voltvec,'r',label='-SLM270')
		...
		axarr[1].bar(ind+width, [e8Hz1, e8Hz2, e8Hz3, e8Hz4, e8Hz5, e8Hz6, e8Hz7, e8Hz8, e8Hz9, e8Hz10], width, color='k')
		axarr[1].set_xticks(ind+width)
		axarr[1].set_xticklabels(('Base','X1 Theta','-CA3','-EC3','-SR90','-SR180','-SR270','-SLM90','-SLM180','-SLM270'),fontsize=font_size-3, fontweight='bold', rotation=45)
		...
		axarr.plot(Rads_1XRhythm_Sorted,IF_ThetaX1_Sorted,color='tomato',label='X1 Theta')
		...
		axarr.plot(Rads_SR90Removed_Sorted,IF_SR90Removed_Sorted,'m',label='-SR90')
		axarr.plot(Rads_SR180Removed_Sorted,IF_SR180Removed_Sorted,'y',label='-SR180')
		axarr.plot(Rads_SR270Removed_Sorted,IF_SR270Removed_Sorted,'b',label='-SR270')
		axarr.plot(Rads_SLM90Removed_Sorted,IF_SLM90Removed_Sorted,'k',label='-SLM90')
		axarr.plot(Rads_SLM180Removed_Sorted,IF_SLM180Removed_Sorted,color='orange',label='-SLM180')
		axarr.plot(Rads_SLM270Removed_Sorted,IF_SLM270Removed_Sorted,'r',label='-SLM270')
		position = 292.5
		...
		axarr.plot(Rads_SR90Removed_MeanBins,IF_SR90Removed_MeanBins,'m',label='-SR90')
		...
		axarr.plot(Rads_SR180Removed_MeanBins,IF_SR180Removed_MeanBins,'y',label='-SR180')
		...
		axarr.plot(Rads_SR270Removed_MeanBins,IF_SR270Removed_MeanBins,'b',label='-SR270')
		...
		axarr.plot(Rads_SLM90Removed_MeanBins,IF_SLM90Removed_MeanBins,'k',label='-SLM90')
		...
		axarr.plot(Rads_SLM180Removed_MeanBins,IF_SLM180Removed_MeanBins,color='orange',label='-SLM180')
		...
		axarr.plot(Rads_SLM270Removed_MeanBins,IF_SLM270Removed_MeanBins,'r',label='-SLM270')
		...
		axarr.set_xticklabels(['0$^\circ$', '45$^\circ$', '90$^\circ$\nPeak', '135$^\circ$', '180$^\circ$', '225$^\circ$', '270$^\circ$\nTrough', '315$^\circ$'])
		pyplot.tight_layout()
		pyplot.savefig('PLOTfiles/' + Case + '_PolarPlotBinnedSR90Removed_' + ExampleString + '_' + str('%0.2f' %h.prethetanoise) + '_prethetanoise.pdf', bbox_inches='tight')
		pyplot.savefig('PLOTfiles/' + Case + '_PolarPlotBinnedSR90Removed_' + ExampleString + '_' + str('%0.2f' %h.prethetanoise) + '_prethetanoise.png', bbox_inches='tight')
		pyplot.gcf().clear()
		pyplot.cla()
		pyplot.clf()
		pyplot.close()
		...
		axarr.set_xticklabels(['0$^\circ$', '45$^\circ$', '90$^\circ$\nPeak', '135$^\circ$', '180$^\circ$', '225$^\circ$', '270$^\circ$\nTrough', '315$^\circ$'])
		pyplot.tight_layout()
		pyplot.savefig('PLOTfiles/' + Case + '_PolarPlotBinnedSR180Removed_' + ExampleString + '_' + str('%0.2f' %h.prethetanoise) + '_prethetanoise.pdf', bbox_inches='tight')
		pyplot.savefig('PLOTfiles/' + Case + '_PolarPlotBinnedSR180Removed_' + ExampleString + '_' + str('%0.2f' %h.prethetanoise) + '_prethetanoise.png', bbox_inches='tight')
		pyplot.gcf().clear()
		pyplot.cla()
		pyplot.clf()
		pyplot.close()
		...
		axarr.set_xticklabels(['0$^\circ$', '45$^\circ$', '90$^\circ$\nPeak', '135$^\circ$', '180$^\circ$', '225$^\circ$', '270$^\circ$\nTrough', '315$^\circ$'])
		pyplot.tight_layout()
		pyplot.savefig('PLOTfiles/' + Case + '_PolarPlotBinnedSR270Removed_' + ExampleString + '_' + str('%0.2f' %h.prethetanoise) + '_prethetanoise.pdf', bbox_inches='tight')
		pyplot.savefig('PLOTfiles/' + Case + '_PolarPlotBinnedSR270Removed_' + ExampleString + '_' + str('%0.2f' %h.prethetanoise) + '_prethetanoise.png', bbox_inches='tight')
		pyplot.gcf().clear()
		pyplot.cla()
		pyplot.clf()
		pyplot.close()
		...
		axarr.set_xticklabels(['0$^\circ$', '45$^\circ$', '90$^\circ$\nPeak', '135$^\circ$', '180$^\circ$', '225$^\circ$', '270$^\circ$\nTrough', '315$^\circ$'])
		pyplot.tight_layout()
		pyplot.savefig('PLOTfiles/' + Case + '_PolarPlotBinnedSLM90Removed_' + ExampleString + '_' + str('%0.2f' %h.prethetanoise) + '_prethetanoise.pdf', bbox_inches='tight')
		pyplot.savefig('PLOTfiles/' + Case + '_PolarPlotBinnedSLM90Removed_' + ExampleString + '_' + str('%0.2f' %h.prethetanoise) + '_prethetanoise.png', bbox_inches='tight')
		pyplot.gcf().clear()
		pyplot.cla()
		pyplot.clf()
		pyplot.close()
		...
		axarr.set_xticklabels(['0$^\circ$', '45$^\circ$', '90$^\circ$\nPeak', '135$^\circ$', '180$^\circ$', '225$^\circ$', '270$^\circ$\nTrough', '315$^\circ$'])
		pyplot.tight_layout()
		pyplot.savefig('PLOTfiles/' + Case + '_PolarPlotBinnedSLM180Removed_' + ExampleString + '_' + str('%0.2f' %h.prethetanoise) + '_prethetanoise.pdf', bbox_inches='tight')
		pyplot.savefig('PLOTfiles/' + Case + '_PolarPlotBinnedSLM180Removed_' + ExampleString + '_' + str('%0.2f' %h.prethetanoise) + '_prethetanoise.png', bbox_inches='tight')
		pyplot.gcf().clear()
		pyplot.cla()
		pyplot.clf()
		pyplot.close()
		...
		axarr.set_xticklabels(['0$^\circ$', '45$^\circ$', '90$^\circ$\nPeak', '135$^\circ$', '180$^\circ$', '225$^\circ$', '270$^\circ$\nTrough', '315$^\circ$'])
		pyplot.tight_layout()
		pyplot.savefig('PLOTfiles/' + Case + '_PolarPlotBinnedSLM270Removed_' + ExampleString + '_' + str('%0.2f' %h.prethetanoise) + '_prethetanoise.pdf', bbox_inches='tight')
		pyplot.savefig('PLOTfiles/' + Case + '_PolarPlotBinnedSLM270Removed_' + ExampleString + '_' + str('%0.2f' %h.prethetanoise) + '_prethetanoise.png', bbox_inches='tight')
		pyplot.gcf().clear()
		pyplot.cla()
		pyplot.clf()
		pyplot.close()
