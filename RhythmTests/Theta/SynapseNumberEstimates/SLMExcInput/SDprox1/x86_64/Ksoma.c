...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Ksoma /home/alexandreguet-mccreight/Resilio Sync/SkinnerLab/Usages/RhythmTests_N1/Theta/SynapseNumberEstimates/SLMExcInput/SDprox1/x86_64/Ksoma.mod\n");
