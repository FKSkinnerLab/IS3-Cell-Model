...
extern Memb_func* memb_func;
 ...
 "setdata_CaE", _hoc_setdata,
 "rates_CaE", _hoc_rates,
 "states_CaE", _hoc_states,
 0, 0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 15, 4);
 	...
 	ivoc_help("help ?1 CaE /Users/alexgm/Desktop/SkinnerLab/Usages/Morphological Reduction/PurkReductionOnLine/x86_64/CaE.mod\n");
...
static int _reset;
static char *modelname = "E calcium current";
...
static int  _f_rates ( _threadargsprotocomma_ double _lv ) {
 ...
 _lq10 = pow( 3.0 , ( ( celsius - 37.0 ) / 10.0 ) ) ;
   _ltinc = - dt * _lq10 ;
   _lalpha = 2.6 / ( 1.0 + exp ( ( _lv + 7.0 ) / ( - 8.0 ) ) ) ;
   _lbeta = 0.18 / ( 1.0 + exp ( ( _lv + 26.0 ) / 4.0 ) ) ;
   _lsum = _lalpha + _lbeta ;
   minf = _lalpha / _lsum ;
   mexp = 1.0 - exp ( _ltinc * _lsum / 4.0 ) ;
   _lalpha = 0.0025 / ( 1.0 + exp ( ( _lv + 32.0 ) / 8.0 ) ) ;
   _lbeta = 0.19 / ( 1.0 + exp ( ( _lv + 42.0 ) / ( - 10.0 ) ) ) ;
   _lsum = _lalpha + _lbeta ;
   hinf = _lalpha / _lsum ;
   hexp = 1.0 - exp ( _ltinc * _lsum / 10.0 ) ;
    return 0; }
...
static int _ode_count(int _type){ hoc_execerror("CaE", "cannot be used with CVODE"); return 0;}
