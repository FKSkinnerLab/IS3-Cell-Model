...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 9, 2);
 	...
 	ivoc_help("help ?1 NaP /Users/alexgm/Desktop/SkinnerLab/Usages/Morphological Reduction/PurkReductionOnLine/x86_64/NaP.mod\n");
...
static int  _f_rates ( _threadargsprotocomma_ double _lv ) {
 ...
 _lq10 = pow( 3.0 , ( ( celsius - 37.0 ) / 10.0 ) ) ;
   _ltinc = - dt * _lq10 ;
   _lalpha = 200.0 / ( 1.0 + exp ( ( _lv - 18.0 ) / ( - 16.0 ) ) ) ;
   _lbeta = 25.0 / ( 1.0 + exp ( ( _lv + 58.0 ) / 8.0 ) ) ;
