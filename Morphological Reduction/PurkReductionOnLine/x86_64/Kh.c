...
extern Memb_func* memb_func;
 ...
 "setdata_Kh", _hoc_setdata,
 "rates_Kh", _hoc_rates,
 "states_Kh", _hoc_states,
 0, 0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 10, 2);
 	...
 	ivoc_help("help ?1 Kh /Users/alexgm/Desktop/SkinnerLab/Usages/Morphological Reduction/PurkReductionOnLine/x86_64/Kh.mod\n");
...
static int  _f_rates ( _threadargsprotocomma_ double _lv ) {
 ...
 _lq10 = pow( 3.0 , ( ( celsius - 37.0 ) / 10.0 ) ) ;
   _ltinc = - dt * _lq10 ;
   minf = 1.0 / ( 1.0 + exp ( ( _lv + 78.0 ) / 7.0 ) ) ;
   mexp = 1.0 - exp ( _ltinc / 38.0 ) ;
   nexp = 1.0 - exp ( _ltinc / 319.0 ) ;
    return 0; }
...
static int _ode_count(int _type){ hoc_execerror("Kh", "cannot be used with CVODE"); return 0;}
