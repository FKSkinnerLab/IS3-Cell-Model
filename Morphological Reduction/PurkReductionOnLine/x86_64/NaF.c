...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 13, 2);
 	...
 	ivoc_help("help ?1 NaF /Users/alexgm/Desktop/SkinnerLab/Usages/Morphological Reduction/PurkReductionOnLine/x86_64/NaF.mod\n");
...
static int _reset;
static char *modelname = "Fast sodium current";
...
static int  _f_rates ( _threadargsprotocomma_ double _lv ) {
 ...
 _lq10 = pow( 3.0 , ( ( celsius - 37.0 ) / 10.0 ) ) ;
   _ltinc = - dt * _lq10 ;
   _lalpha = 35.0 / exp ( ( _lv + 5.0 ) / ( - 10.0 ) ) ;
   _lbeta = 7.0 / exp ( ( _lv + 65.0 ) / 20.0 ) ;
   _lsum = _lalpha + _lbeta ;
   minf = _lalpha / _lsum ;
   mexp = 1.0 - exp ( _ltinc * _lsum ) ;
   _lalpha = 0.225 / ( 1.0 + exp ( ( _lv + 80.0 ) / 10.0 ) ) ;
   _lbeta = 7.5 / exp ( ( _lv - 3.0 ) / ( - 18.0 ) ) ;
   _lsum = _lalpha + _lbeta ;
   hinf = _lalpha / _lsum ;
