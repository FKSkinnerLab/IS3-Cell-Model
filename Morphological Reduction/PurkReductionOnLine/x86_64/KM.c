...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 9, 2);
 	...
 	ivoc_help("help ?1 KM /Users/alexgm/Desktop/SkinnerLab/Usages/Morphological Reduction/PurkReductionOnLine/x86_64/KM.mod\n");
...
static int _reset;
static char *modelname = "Persistent potassium current";
...
static int  _f_rates ( _threadargsprotocomma_ double _lv ) {
   double _lq10 , _ltinc , _lsum ;
 _lq10 = pow( 3.0 , ( ( celsius - 37.0 ) / 10.0 ) ) ;
   _ltinc = - dt * _lq10 ;
   _lsum = 3.3 * ( exp ( ( _lv + 35.0 ) / 40.0 ) + exp ( - ( _lv + 35.0 ) / 20.0 ) ) / 200.0 ;
   minf = 1.0 / ( 1.0 + exp ( - ( _lv + 35.0 ) / 10.0 ) ) ;
