...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 13, 4);
 	...
 	ivoc_help("help ?1 CaP2 /Users/alexgm/Desktop/SkinnerLab/Usages/Morphological Reduction/PurkReductionOnLine/x86_64/CaP2.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("CaP2", "cannot be used with CVODE"); return 0;}
