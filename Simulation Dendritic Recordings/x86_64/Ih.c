...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 6, 4);
 	...
 	ivoc_help("help ?1 Ih /Users/alexgm/Desktop/SkinnerLab/Usages/Simulation Dendritic Recordings/x86_64/Ih.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  state();
 if(error){fprintf(stderr,"at line 83 in file Ih.mod:\n        SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
