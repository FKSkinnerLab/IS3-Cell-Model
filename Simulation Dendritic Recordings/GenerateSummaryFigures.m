...
Case = 7;
tvec = 0.1:0.1:3000.1;
Recordings = load(['~/Desktop/SkinnerLab/Usages/Simulation Dendritic Recordings/Recordings/model_'...
    num2str(Case) '_Case_DendriteRecordings.dat']);
Distances = load(['~/Desktop/SkinnerLab/Usages/Simulation Dendritic Recordings/Recordings/model_'...
    num2str(Case) '_Case_Distances.dat']);
