...
pyplot.hist(HC_EI2_MetricVec, 100, alpha=0.5, label='High-Conductance')
pyplot.legend(loc='upper right')
pyplot.xlim(numpy.amin(HC_EI2_MetricVec),-numpy.amin(HC_EI2_MetricVec))
pyplot.xlabel("EI Metric #2", fontsize=font_size)
pyplot.ylabel("HC Scenario Count", fontsize=font_size)
pyplot.savefig(Case + "_EI2MetricHist_HCOnly.png", bbox_inches='tight')
pyplot.gcf().clear()
pyplot.cla()
pyplot.clf()
pyplot.close()
...
pyplot.xlabel("EI Metric #2", fontsize=font_size)
pyplot.ylabel("HC Scenario Count", fontsize=font_size)
pyplot.savefig(Case + "_HCEI2MetricPoolHist_Zoomed.png", bbox_inches='tight')
pyplot.gcf().clear()
pyplot.cla()
pyplot.clf()
pyplot.close()

EI2MetricVec = numpy.zeros(len(HC_PoolStrings_HC_PoolNums[2]), dtype = numpy.int)
for y in range(len(HC_PoolStrings_HC_PoolNums[2])):
	EI2MetricVec[y] = HC_PoolStrings_HC_PoolNums[2][y][5]
pyplot.hist(EI2MetricVec, bin_number, alpha=0.5, label=HC_PoolStrings[0])
pyplot.legend(loc='upper right')
pyplot.xlim(numpy.amin(EI2MetricVec),-numpy.amin(EI2MetricVec))
pyplot.xlabel("EI Metric #2", fontsize=font_size)
pyplot.ylabel("HC Scenario Count", fontsize=font_size)
pyplot.savefig(Case + "_HCEI2MetricPoolHist_LNI_LNE_LIS_LES.png", bbox_inches='tight')
pyplot.gcf().clear()
pyplot.cla()
pyplot.clf()
pyplot.close()
