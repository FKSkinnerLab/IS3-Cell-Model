def PoolDivide(NumInhVec,NumExcVec,InhSpikesVec,ExcSRSpikesVec,NumSpikes,stringvar):
	...
	PoolNumSpikes = numpy.zeros((len(ExampleStrings),), dtype=numpy.float64)
	...
	PoolNumSpikes[0] = numpy.mean(NumSpikes[(LowNumInh) & (LowNumExc) & (LowInhSpikes) & (LowExcSpikes)])
	...
	PoolNumSpikes[1] = numpy.mean(NumSpikes[(HighNumInh) & (LowNumExc) & (LowInhSpikes) & (LowExcSpikes)])
	...
	PoolNumSpikes[2] = numpy.mean(NumSpikes[(LowNumInh) & (HighNumExc) & (LowInhSpikes) & (LowExcSpikes)])
	...
	PoolNumSpikes[3] = numpy.mean(NumSpikes[(HighNumInh) & (HighNumExc) & (LowInhSpikes) & (LowExcSpikes)])
	...
	PoolNumSpikes[4] = numpy.mean(NumSpikes[(LowNumInh) & (LowNumExc) & (HighInhSpikes) & (LowExcSpikes)])
	...
	PoolNumSpikes[5] = numpy.mean(NumSpikes[(HighNumInh) & (LowNumExc) & (HighInhSpikes) & (LowExcSpikes)])
	...
	PoolNumSpikes[6] = numpy.mean(NumSpikes[(LowNumInh) & (HighNumExc) & (HighInhSpikes) & (LowExcSpikes)])
	...
	PoolNumSpikes[7] = numpy.mean(NumSpikes[(HighNumInh) & (HighNumExc) & (HighInhSpikes) & (LowExcSpikes)])
	...
	PoolNumSpikes[8] = numpy.mean(NumSpikes[(LowNumInh) & (LowNumExc) & (LowInhSpikes) & (HighExcSpikes)])
	...
	PoolNumSpikes[9] = numpy.mean(NumSpikes[(HighNumInh) & (LowNumExc) & (LowInhSpikes) & (HighExcSpikes)])
	...
	PoolNumSpikes[10] = numpy.mean(NumSpikes[(LowNumInh) & (HighNumExc) & (LowInhSpikes) & (HighExcSpikes)])
	...
	PoolNumSpikes[11] = numpy.mean(NumSpikes[(HighNumInh) & (HighNumExc) & (LowInhSpikes) & (HighExcSpikes)])
	...
	PoolNumSpikes[12] = numpy.mean(NumSpikes[(LowNumInh) & (LowNumExc) & (HighInhSpikes) & (HighExcSpikes)])
	...
	PoolNumSpikes[13] = numpy.mean(NumSpikes[(HighNumInh) & (LowNumExc) & (HighInhSpikes) & (HighExcSpikes)])
	...
	PoolNumSpikes[14] = numpy.mean(NumSpikes[(LowNumInh) & (HighNumExc) & (HighInhSpikes) & (HighExcSpikes)])
	...
	PoolNumSpikes[15] = numpy.mean(NumSpikes[(HighNumInh) & (HighNumExc) & (HighInhSpikes) & (HighExcSpikes)])
	
	return ExampleStrings, PoolNums, PoolNumSpikes
