...
HC_PoolNumsMat[0][1] = HC_PoolNums[11]
HC_PoolNumsMat[0][2] = HC_PoolNums[14]
HC_PoolNumsMat[0][3] = HC_PoolNums[15]

HC_PoolNumsMat[1][0] = HC_PoolNums[8]
HC_PoolNumsMat[1][1] = HC_PoolNums[9]
HC_PoolNumsMat[1][2] = HC_PoolNums[12]
HC_PoolNumsMat[1][3] = HC_PoolNums[13]

HC_PoolNumsMat[2][0] = HC_PoolNums[2]
HC_PoolNumsMat[2][1] = HC_PoolNums[3]
HC_PoolNumsMat[2][2] = HC_PoolNums[6]
HC_PoolNumsMat[2][3] = HC_PoolNums[7]

HC_PoolNumsMat[3][0] = HC_PoolNums[0]
HC_PoolNumsMat[3][1] = HC_PoolNums[1]
HC_PoolNumsMat[3][2] = HC_PoolNums[4]
...
DB_PoolNumsMat[0][1] = DB_PoolNums[11]
DB_PoolNumsMat[0][2] = DB_PoolNums[14]
DB_PoolNumsMat[0][3] = DB_PoolNums[15]

DB_PoolNumsMat[1][0] = DB_PoolNums[8]
DB_PoolNumsMat[1][1] = DB_PoolNums[9]
DB_PoolNumsMat[1][2] = DB_PoolNums[12]
DB_PoolNumsMat[1][3] = DB_PoolNums[13]

DB_PoolNumsMat[2][0] = DB_PoolNums[2]
DB_PoolNumsMat[2][1] = DB_PoolNums[3]
DB_PoolNumsMat[2][2] = DB_PoolNums[6]
DB_PoolNumsMat[2][3] = DB_PoolNums[7]

DB_PoolNumsMat[3][0] = DB_PoolNums[0]
DB_PoolNumsMat[3][1] = DB_PoolNums[1]
DB_PoolNumsMat[3][2] = DB_PoolNums[4]
...
NHC_PoolNumsMat[0][1] = NHC_PoolNums[11]
NHC_PoolNumsMat[0][2] = NHC_PoolNums[14]
NHC_PoolNumsMat[0][3] = NHC_PoolNums[15]

NHC_PoolNumsMat[1][0] = NHC_PoolNums[8]
NHC_PoolNumsMat[1][1] = NHC_PoolNums[9]
NHC_PoolNumsMat[1][2] = NHC_PoolNums[12]
NHC_PoolNumsMat[1][3] = NHC_PoolNums[13]

NHC_PoolNumsMat[2][0] = NHC_PoolNums[2]
NHC_PoolNumsMat[2][1] = NHC_PoolNums[3]
NHC_PoolNumsMat[2][2] = NHC_PoolNums[6]
NHC_PoolNumsMat[2][3] = NHC_PoolNums[7]

NHC_PoolNumsMat[3][0] = NHC_PoolNums[0]
NHC_PoolNumsMat[3][1] = NHC_PoolNums[1]
NHC_PoolNumsMat[3][2] = NHC_PoolNums[4]
...
Rat_PoolNumsMat[0][1] = HCDBRatios[11]
Rat_PoolNumsMat[0][2] = HCDBRatios[14]
Rat_PoolNumsMat[0][3] = HCDBRatios[15]

Rat_PoolNumsMat[1][0] = HCDBRatios[8]
Rat_PoolNumsMat[1][1] = HCDBRatios[9]
Rat_PoolNumsMat[1][2] = HCDBRatios[12]
Rat_PoolNumsMat[1][3] = HCDBRatios[13]

Rat_PoolNumsMat[2][0] = HCDBRatios[2]
Rat_PoolNumsMat[2][1] = HCDBRatios[3]
Rat_PoolNumsMat[2][2] = HCDBRatios[6]
Rat_PoolNumsMat[2][3] = HCDBRatios[7]

Rat_PoolNumsMat[3][0] = HCDBRatios[0]
Rat_PoolNumsMat[3][1] = HCDBRatios[1]
Rat_PoolNumsMat[3][2] = HCDBRatios[4]
...
Rat2_PoolNumsMat[0][1] = HCNHCRatios[11]
Rat2_PoolNumsMat[0][2] = HCNHCRatios[14]
Rat2_PoolNumsMat[0][3] = HCNHCRatios[15]

Rat2_PoolNumsMat[1][0] = HCNHCRatios[8]
Rat2_PoolNumsMat[1][1] = HCNHCRatios[9]
Rat2_PoolNumsMat[1][2] = HCNHCRatios[12]
Rat2_PoolNumsMat[1][3] = HCNHCRatios[13]

Rat2_PoolNumsMat[2][0] = HCNHCRatios[2]
Rat2_PoolNumsMat[2][1] = HCNHCRatios[3]
Rat2_PoolNumsMat[2][2] = HCNHCRatios[6]
Rat2_PoolNumsMat[2][3] = HCNHCRatios[7]

Rat2_PoolNumsMat[3][0] = HCNHCRatios[0]
Rat2_PoolNumsMat[3][1] = HCNHCRatios[1]
Rat2_PoolNumsMat[3][2] = HCNHCRatios[4]
