...
hold on
% add box proxdist1
plot([366,366],[0.04,2.4],'-.k')
hold on
plot([373,373],[0.04,2.4],'-.k')
hold on
plot([366,373],[2.4,2.4],'-.k')
hold on
plot([366,373],[0.04,0.04],'-.k')
hold on
text(320,2.2,'Distal Tree 2B \rightarrow','FontSize',font_size-7,'FontWeight','Bold')
% add box proxdist2
plot([467,467],[0,0.05],'-.k')
hold on
plot([472,472],[0,0.05],'-.k')
hold on
plot([467,472],[0.05,0.05],'-.k')
hold on
plot([467,472],[0,0],'-.k')
hold on
...
% xlabel('Time (ms)')
% ylabel('Voltage (mV)')
title(['Synapse at ',num2str(proxdist1),' \mum from Soma (Tree 2B)'])
...
title(['Synapse at ',num2str(proxdist2),' \mum from Soma (Tree 1)'])
