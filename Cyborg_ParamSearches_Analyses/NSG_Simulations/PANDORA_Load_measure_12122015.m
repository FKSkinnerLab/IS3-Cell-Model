...
% TopDirSim = '~/Desktop/SkinnerLab/Usages/NSG_Simulations/output/Case9StarPSIBAuRg/Cipres_Data/output/Case9StarModel/';
% TopDirSim = '~/Desktop/SkinnerLab/Usages/NSG_Simulations/output/Case8StarPSIBAuRg/Older Runs/Cipres_Data_4/output/Case8StarModel/';
TopDirSim = '~/Desktop/SkinnerLab/Usages/NSG_Simulations/output/Case9StarPSIBAuRg/Older Runs/Cipres_Data_2/output/Case9StarModel/';
...
for Rank_To_Plot = 1;
    ...
    f1 = [TopDirSim 'model_' num2str(ssd_params(1,1)) '_ModNum_'...
        ...
        '_Kdrf_' num2str(ssd_params(1,5)) '_KA_' num2str(ssd_params(1,6)) '_DistFromSoma_-0.1_InjectionMagnitude.dat'];
    f2 = [TopDirSim 'model_' num2str(ssd_params(1,1)) '_ModNum_'...
        num2str(ssd_params(1,2)) '_NaT_' num2str(ssd_params(1,3)) '_NaP_' num2str(ssd_params(1,4)) ...
        '_Kdrf_' num2str(ssd_params(1,5)) '_KA_' num2str(ssd_params(1,6)) '_DistFromSoma_0.02_InjectionMagnitude.dat'];
    f3 = [TopDirSim 'model_' num2str(ssd_params(1,1)) '_ModNum_'...
        num2str(ssd_params(1,2)) '_NaT_' num2str(ssd_params(1,3)) '_NaP_' num2str(ssd_params(1,4)) ...
        '_Kdrf_' num2str(ssd_params(1,5)) '_KA_' num2str(ssd_params(1,6)) '_DistFromSoma_0.05_InjectionMagnitude.dat'];
    f4 = [TopDirSim 'model_' num2str(ssd_params(1,1)) '_ModNum_'...
        num2str(ssd_params(1,2)) '_NaT_' num2str(ssd_params(1,3)) '_NaP_' num2str(ssd_params(1,4)) ...
        '_Kdrf_' num2str(ssd_params(1,5)) '_KA_' num2str(ssd_params(1,6)) '_DistFromSoma_0.5_InjectionMagnitude.dat'];
...
%     subplot('Position',[0.01 0 1 1]) % If minimizing white space
    subplot('Position',[0.01 0 1 0.92]) % If plotting legend
...
%     text(1350,20,'S.1','FontSize',font_size+2,'FontWeight','bold')
    ...
    axis off
    hold off
    legend([p1 p2 p3 p4],'Hyperpolarization','Passive Depolarization','Active Depolarization','Depolarization Block','Position',[425 350 0.1 0.1])
...
for i = 1:length(CIP_dists(1,:))
    ...
    NdimdbCIP = reshape(sortedCIPdists(:,end),[NaTnumparams,NaPnumparams,Kdrfnumparams,Kanumparams,DISTnumparams]); % Reshapes distance vector into N-dimensional matrix
...
NdimdbFreq = reshape(sortedFreqs(:,FreqAtMaxThetaPeak),...
    [NaTnumparams,NaPnumparams,Kdrfnumparams,Kanumparams,DISTnumparams]); % Reshapes distance vector into N-dimensional matrix
...
figure(18)
hist3(ssd_params_dist_sorted(:,[2 6]),[NaTnumparams DISTnumparams],'FaceAlpha',.65)
xlabel('NaT (S/cm^2)')
ylabel('Distance (\mum)')
set(gcf,'renderer','opengl');
set(get(gca,'child'),'FaceColor','interp','CDataMode','auto');
...
figure(21)
hist3(ssd_params_dist_sorted(:,[3 6]),[NaPnumparams DISTnumparams],'FaceAlpha',.65)
xlabel('NaP (S/cm^2)')
ylabel('Distance (\mum)')
set(gcf,'renderer','opengl');
set(get(gca,'child'),'FaceColor','interp','CDataMode','auto');
...
figure(23)
hist3(ssd_params_dist_sorted(:,[4 6]),[Kdrfnumparams DISTnumparams],'FaceAlpha',.65)
xlabel('Kdrf (S/cm^2)')
ylabel('Distance (\mum)')
set(gcf,'renderer','opengl');
set(get(gca,'child'),'FaceColor','interp','CDataMode','auto');
...
% Kdrs
figure(24)
hist3(ssd_params_dist_sorted(:,[5 6]),[Kanumparams DISTnumparams],'FaceAlpha',.65)
xlabel('Ka (S/cm^2)')
ylabel('Distance (\mum)')
set(gcf,'renderer','opengl');
set(get(gca,'child'),'FaceColor','interp','CDataMode','auto');
...
display('Model #      G_NaT        N_NaP         G_Kdrf        G_Ka         DistanceFromSoma      Distance')
