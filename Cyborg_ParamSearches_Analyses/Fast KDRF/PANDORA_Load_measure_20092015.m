...
TopDirSim = '~/Desktop/SkinnerLab/Usages/Fast KDRF/Case 2/';
...
%     text(1350,20,'S.1','FontSize',font_size+2,'FontWeight','bold')
    ...
    axis off
    hold off
%     legend([p1 p2 p3 p4],'Hyperpolarization','Passive Depolarization','Active Depolarization','Depolarization Block','Position',[455 380 0.1 0.1])
%     subplot(2,1,1)
